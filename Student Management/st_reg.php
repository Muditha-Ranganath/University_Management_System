	...
	<div class="st_reg fix">
		...
		<form action="" method="post" id="st_form">
			<table>
				...
				<tr>
					<th>Student ID: </th>
					<td><input type="id" name="st_id" placeholder="Student Id" pattern="[S][0-9]{6}" required /></td>
				</tr>
				<tr>
					<th>Password: </th>
				...
				<tr>
					<th>Contact:</th>
					<td><input type="text" name="st_contact" placeholder="phone" pattern="[0-9]{10}" required /></td>
				</tr>
				<tr>
					<th>Gender:</th>
