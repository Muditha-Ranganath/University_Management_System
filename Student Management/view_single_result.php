...
<div class="all_student fix">
		...
		function credit_hour($x){
			if($x=="Programming applications and frameworks") return 3;
			elseif($x == "Database system") return 1;
			elseif($x == "Network Design and Management") return 4;
			elseif($x == "Employability skills development") return 3;
			elseif($x == "IT project management") return 1;
			elseif($x == "Mobile application development") return 4;
			elseif($x == "Professional skills") return 3;
			elseif($x == "Probability and statistic") return 3;
			elseif($x == "Data Structures and Algorithms") return 3;
		}
