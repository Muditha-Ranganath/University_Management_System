            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Contact Number" name="contact" pattern="[0-9]{10}" required="required" >
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="NID" name="nid" pattern="[0-9]{9}[V]" required="required">
                        </div>
