            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" pattern="[0-9]{10} name="contact" value="<?php echo $contact;?>">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" pattern="[0-9]{9}[V] name="nid" value="<?php echo $nid;?>">
                        </div>
